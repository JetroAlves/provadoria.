        ...
        <div className="max-w-md w-full mx-auto space-y-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`w-full py-5 text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-2xl transition-all flex items-center justify-center gap-3 active:scale-[0.98] group ${
                success ? 'bg-emerald-500' : 'bg-black hover:bg-slate-800 disabled:opacity-50'
              }`}
            >
              {isSubmitting ? (
